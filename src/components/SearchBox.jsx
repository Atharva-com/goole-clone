...
const SearchBox = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className='flex border border-gray-200 rounded-full shadow-lg px-6 py-2 ml-10 mr-5 flex-grow max-w-3xl items-center'>
      ...
      <AiOutlineSearch onClick={handleSubmit} className='text-2xl hidden sm:inline-flex tetx-blue-500 cursor-pointer'/>
    </form>
  )
}
